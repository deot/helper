...
这篇指南会指导你如何为 `@deot/helper` 贡献一份自己的力量，请在你要提 `issue` 或者 `pull request` 之前花几分钟来阅读一遍这篇指南。
...
我们使用 [`GitHub Issues`](https://github.com/deot/helper/issues) 来做 `bug` 追踪。

在你报告一个 `bug` 之前，请先确保已经搜索过已有的 `issue` 和阅读了我们的 [常见问题](https://github.com/deot/helper/wiki/FAQ)。
